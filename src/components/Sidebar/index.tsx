        ...
        <nav className="px-4 py-4 lg:px-6">
          ...
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        href="/"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-3 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === "/" ||
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="flex flex-col py-1 pl-6">
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/products/list-products" &&
                                "text-white"
                              } `}
                            >
                          ...
                          <li>
                            ...
                            >
                              <div className="text-sm">Danh sách danh mục</div>
                            </Link>
                          </li>
                        </ul>
                      </div>
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/stores" || pathname.includes("stores")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <StorefrontIcon />
                        <div className="text-sm">Quản lý cửa hàng</div>
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${
                            open && "rotate-180"
                          }`}
                        ...
                        <ul className="flex flex-col py-1 pl-6">
                          <li>
                            <Link
                              href="/stores"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/stores" && "text-white"
                              } `}
                            >
                              <div className="text-sm">Danh sách cửa hàng</div>
                            </Link>
                          </li>
                        </ul>
                      </div>
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="flex flex-col py-1 pl-6">
                          <li>
                            <Link
                              href="/orders/list-orders"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/orders/list-orders" &&
                                "text-white"
                              } `}
                            >
                              <div className="text-sm">Danh sách đơn hàng</div>
                            </Link>
                          </li>
                        </ul>
                      </div>
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/vouchers" || pathname.includes("vouchers")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        ...
                        <div className="text-sm">Quản lý vouchers</div>
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${
                            open && "rotate-180"
                          }`}
                      ...
                      >
                        <ul className="flex flex-col py-1 pl-6">
                          <li>
                            <Link
                              href="/vouchers/create-voucher"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/vouchers/create-voucher" &&
                                "text-white"
                              } `}
                            >
                              <div className="text-sm">Tạo voucher</div>
                            </Link>
                          </li>
                          <li>
                            <Link
                              href="/vouchers/list-vouchers"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/vouchers/list-vouchers" &&
                                "text-white"
                              } `}
                            >
                              <div className="text-sm">Danh sách vouchers</div>
                            </Link>
                          </li>
                        </ul>
                      </div>
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/reviews" || pathname.includes("reviews")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        ...
                        <div className="text-sm">Quản lý đánh giá</div>
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${
                            open && "rotate-180"
                          }`}
                      ...
                      >
                        <ul className="flex flex-col py-1 pl-6">
                          <li>
                            ...
                            >
                              <div className="text-sm">Danh sách đánh giá</div>
                            </Link>
                          </li>
                        </ul>
                      </div>
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/auctions" || pathname.includes("auctions")
                }
              >
                {(handleClick, open) => {
                  return (
                        ...
                        <ul className="flex flex-col py-1 pl-6">
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                (pathname === "/auctions" ||
                                  pathname.match(/^\/auctions\/\w+$/)) &&
                                "text-white"
                              } `}
                            >
                              <div className="text-sm">Dự án đang đặt giá</div>
                            </Link>
                          </li>
                          <li>
                            <Link
