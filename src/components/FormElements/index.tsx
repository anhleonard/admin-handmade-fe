...
import ColumnTabButton from "@/libs/col-tab-button";
import MyTextAction from "@/libs/text-action";
import RowTabButton from "@/libs/row-tab-button";
        ...
        <div className="flex flex-col gap-9">
          ...
          <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div className="flex flex-col gap-5.5 p-6.5">
              <RowTabButton
                items={[
                  { label: "Tất cả đơn hàng", href: "/" },
                  { label: "Chờ thanh toán", href: "/profile" },
                ]}
              />
              <ColumnTabButton
                items={[
              ...
              <MyTextAction
                label="Chỉnh sửa"
                onClick={() => console.log("hello nha")}
              />
              <MyTabButton
                isSelected
                onClick={() => console.log("welcome to ha noi")}
              >
                Tất cả
              </MyTabButton>
              <MyTabButton isSelected={false}>5 Sao (1300)</MyTabButton>
              <MyLabel type="progress">Xin chào</MyLabel>
              <Button color="info">
                <div className="text-sm md:text-base lg:text-xl">ĐẶT HÀNG</div>
              </Button>
